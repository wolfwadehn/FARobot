...
[assembly: InternalsVisibleTo ("FRobot.Test")]
...
public partial class App : Application {
   ...
   public static void CheckExpired () {
      ...
      if (now.Year * 12 + now.Month > year * 12 + exMonth)
         MessageBox.Show (App.Current.MainWindow, "This version is old.\n\nPlease get the latest version for more stable features.", "FRobot", MessageBoxButton.OK);
   }
   ...
   static void OnUnhandledException (object sender, DispatcherUnhandledExceptionEventArgs e) {
      MessageBox.Show (App.Current.MainWindow, e.Exception.ToString (), "FRobot encountered a problem (Dispatcher)", MessageBoxButton.OK);
      e.Handled = true;
   }
   ...
   static void OnDomainUnhandledException (object sender, UnhandledExceptionEventArgs e) {
      MessageBox.Show (App.Current.MainWindow, ((Exception)e.ExceptionObject).ToString (), "FRobot encountered a problem", MessageBoxButton.OK);
   }
}
