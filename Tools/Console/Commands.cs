...
/// <summary>Run the FApp.Test and compute the coverage</summary>
static class ComputeCoverage {
   public static void Run () {
      // First, run FApp.Test under 'dotnet-coverage' to generate a coverage.xml file in F:/Bin
      try {
         var pi = new ProcessStartInfo ("dotnet-coverage.exe", "collect FApp.Test.exe -f xml -o coverage.xml") { WorkingDirectory = $"F:/Bin" };
   ...
   /// <summary>Given a Coverage object with all files, this marks only the files of interest to FApp testing</summary>
...
static class GetNextId {
   public static void Run () {
      Assembly assy = Assembly.LoadFile (Lib.GetLocalFile ("FApp.Test.dll"));
...
/// <summary>Turns optimization on / off for all FApp projects</summary>
...
/// <summary>Turns XML documentation on / off for all FApp projects</summary>
