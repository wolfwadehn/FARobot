...
In FRobot, the six joint sliders in the sidebar do FK.  Dragging one slider
...
In FRobot, the X/Y/Z/Rx/Ry/Rz sliders in the sidebar do IK.  Dragging one slider
...
rendered in the main viewport.  In FRobot there is only one scene after startup:
